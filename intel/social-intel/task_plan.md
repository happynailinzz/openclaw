...
## Goal
按《社交平台情报抓取 SOP（OpenClaw版）》执行 2026-04-19 02:00 UTC 一轮完整 social intel 监控，覆盖 X/小红书/YouTube/Reddit/新闻网站/RSS，并输出固定格式简报、结构化归档与 memory 留痕。
...
|---|---:|---|
| YouTube 原始直连结果相关性不足 | 1 | 改走 Google News 回退，仅保留弱信号，不阻塞主流程 |
| X 缺乏高可信原生增量 | 1 | 记为弱信号/聚合回退，不阻塞主流程 |
